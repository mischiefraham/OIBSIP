...
{  
    ...
    Interface() {
        ...
        panel.add(rb1); panel.add(rb2); panel.add(rb3); panel.add(b);
...
class Register extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (!userValue.equals("") && !passValue.equals("")) {
            try {
                if (isUsernameAvailable(userValue)) {
                    if (registerUser(userValue, passValue)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Username is already present. Please choose a different username.");
                }
    ...
    private boolean isUsernameAvailable(String username) throws ClassNotFoundException, SQLException {
...
class login extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (!userValue.equals("") && !passValue.equals("")) {
            try {
                if (isUserCredentialsValid(userValue, passValue)) {
    ...
    private boolean isUserCredentialsValid(String username, String password) throws ClassNotFoundException, SQLException {
        Class.forName("oracle.jdbc.OracleDriver");
        Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "SYSTEM", "SYSTEM");
...
{  
    ...
    {  
        ...
        if(current==4)  
        {  
            l.setText("Que5: Which environment variable is used to set the java path?");  
        ...
        {  
            ...
            jb[0].setText("for(;;)");jb[1].setText("for()i=0;i<1;i--");jb[2].setText("for(int=0;i++)");jb[3].setText("if(All of the above)");  
        }  
        if(current==6)  
        {  
        ...
        if(current==8)  
        {  
            l.setText("Que9: What is not the use of “this” keyword in Java?");  
